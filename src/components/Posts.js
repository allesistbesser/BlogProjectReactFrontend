...
const Posts = () => {
  ...
  return (
    <div >
      <div className='col-3 mt-5' style={{ position: 'relative', left: '40%' }}>
        {isloading ? null : <img
          ...
          alt="Blog logo"
        />}
        {posts?.length >0 ? <> <FormControl className='float-end col-4 m-2' id='search' value={searchitem} onChange={(e) => setsearchitem(e.target.value)} placeholder='Search in Content or Category' />  </> : null}
